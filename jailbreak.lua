...
print("- Separate golden window (gold border)")
print("- Add players to make their ESP GOLDEN")
print("- Players stack BELOW each other")
print("- Remove players easily with REMOVE button")
print("- Shows how many golden players you have")
print("")
